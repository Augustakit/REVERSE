return {
  AH6 = {
   ...
   REVERSED_TRANSFORM = LinearTransform( --反转视角数据
    ...
    Vec3( 0, 0, 1),
    Vec3( 0, 0, 0]]
    TARGET_OFFSET = Vec3(0, 0, 0),--Gunner 3rd person view target offset, original data is Vec3(2.0, 2.0, -2.0) 
  ...
  Z11W = {
   ...
   REVERSED_TRANSFORM = LinearTransform( --反转视角数据
    ...
    Vec3( 0, 0, 1),
    Vec3( 0, 0, 0]]
    TARGET_OFFSET = Vec3(0, 0, 0),--Gunner 3rd person view target offset, original data is Vec3(2.0, 3.0, -2.0) 
