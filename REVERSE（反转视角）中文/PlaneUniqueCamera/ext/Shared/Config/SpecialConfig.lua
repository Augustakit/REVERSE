return {
  ...
  AAV7A1 = {
   ...
   CHASE_CAM_CONFIG = {
    CAMERA_GUID = Guid('1EF78B88-50DD-42AD-A603-07EF06650823'),   -- 追击相机组件的 GUID
    CAMERA_PARENT_GUID = Guid('5382FE24-FE8A-40C1-97B2-49E97DDA2141'),  -- 父组件的 GUID
  },
   CHASECAMERA_INDEX = 4,
   ...
   GunnerTARGET_OFFSET = Vec3(1.0, 0, 0.029999999329447746)--炮手第三人称视角目标偏移，原数据为 Vec3(1.0, 0, 0.029999999329447746) 
  ...
  M1114 = {
   ...
   CHASE_CAM_CONFIG = {
    CAMERA_GUID = Guid('7F75FD36-50A3-452C-BC3A-CB1C3E458FAF'),   -- 追击相机组件的 GUID
    CAMERA_PARENT_GUID = Guid('ABA9E6FB-E3FB-44A8-9F85-BA2D1C0A4F26'),  -- 父组件的 GUID
  },
   CHASECAMERA_INDEX = 4,
  ...
  GAZ3937 = {
   ...
   CHASE_CAM_CONFIG = {
    CAMERA_GUID = Guid('1FC2DA93-9E11-4635-ADDF-B0DA946BC130'),   -- 追击相机组件的 GUID
    CAMERA_PARENT_GUID = Guid('6E496AA1-249D-460A-92EF-6C418CC6A035'),  -- 父组件的 GUID
  },
   CHASECAMERA_INDEX = 4,
   ...
   TARGET_OFFSET = Vec3(0, 0, 0), --第三人称视角目标偏移，原数据为 Vec3(0, 0.6499999761581421, 0) 
  ...
  ASRAD = {
   ...
   CHASE_CAM_CONFIG = {
    CAMERA_GUID = Guid('AE250BD5-0AF7-4E10-8D3F-C3481E29A44E'),   -- 追击相机组件的 GUID
    CAMERA_PARENT_GUID = Guid('90FB14DA-342F-4699-8BFF-1BB92939886B'),  -- 父组件的 GUID
  },
   CHASECAMERA_INDEX = 4,
   ...
   TARGET_OFFSET = Vec3(0, 0, 1.2999999523162842), --第三人称视角目标偏移，原数据为 Vec3(0, 0.6499999761581421, 0) 
   ...
   GunnerTARGET_OFFSET = Vec3(1.0, 0.5, -0.5)--炮手第三人称视角目标偏移，原数据为
  },
  ...
  VodnikPhoenix = {
   ...
   CHASE_CAM_CONFIG = {
    CAMERA_GUID = Guid('4DF300E5-2BCF-46A2-BC74-2510A3B9AD52'),   -- 追击相机组件的 GUID
    CAMERA_PARENT_GUID = Guid('32EFD7BA-C8BE-4C1E-BD84-F1AFF46BDD30'),  -- 父组件的 GUID
  },
   CHASECAMERA_INDEX = 4,
   ...
   TARGET_OFFSET = Vec3(0, 0.6499999761581421, 0), --第三人称视角目标偏移
   ...
   GunnerTARGET_OFFSET = Vec3(1.0, 1.0, -1.0)--炮手第三人称视角目标偏移，原数据为
  },
