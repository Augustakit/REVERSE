--fighter data
  --F18 data
 F18_CAMERA_TRANSFORM = LinearTransform( --第三人称视角
  Vec3( 1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0, 1),
  Vec3( 0, 0.9798853397369385, -4.482795238494873))

 F18_RESERVE_CAMERA = LinearTransform(   --反转视角数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -0.9, 10))
  ...
  --SU35 data
 SU35_CAMERA_TRANSFORM = LinearTransform( --第三人称视角
  Vec3(1, 0, 0),
  Vec3(0, 1, 0),
  Vec3(0, 0, 1),
  Vec3(0, 1.9803240299224854, -4.482795238494873))

 SU35_RESERVE_CAMERA = LinearTransform(   --反转视角数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -0.9, 10))
  ...
  --F35data
  F35_CAMERA_TRANSFORM = LinearTransform(  --第三人称视角，参考了BF4的数据
  Vec3( 1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0, 1),
  Vec3( 0, 3.5, -12.5834))
 ...
 F35_RESERVE_CAMERA = LinearTransform(   --反转视角数据，参考了BF4的数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
...
--XP5 data
  --F18 Airdata
  F18Air_CAMERA_TRANSFORM = LinearTransform( --第三人称视角
  Vec3( 1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0, 1),
  Vec3( 0, 0.9798853397369385, -4.482795238494873))

 F18Air_RESERVE_CAMERA = LinearTransform(   --反转视角数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -0.9, 10))
  ...
  --SU35 Airdata
 SU35Air_CAMERA_TRANSFORM = LinearTransform( --第三人称视角
  Vec3(1, 0, 0),
  Vec3(0, 1, 0),
  Vec3(0, 0, 1),
  Vec3(0, 1.9803240299224854, -4.482795238494873))

 SU35Air_RESERVE_CAMERA = LinearTransform(   --反转视角数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -0.9, 10))
...
--CAS data
  --A10 data
 A10_CAMERA_TRANSFORM = LinearTransform( --第三人称视角，参考了BF4的A10的数据
  Vec3(1, 0, 0),
...
--[[Vec3(1, 0, 0),                           --第三人称视角原始数据
 ...
 A10_RESERVE_CAMERA = LinearTransform(   --反转视角数据，参考了BF4的数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -2, 26.73792))
  ...
  --SU-25 data
 SU25_CAMERA_TRANSFORM = LinearTransform( --第三人称视角，参考了BF4的SU25的数据
  Vec3(1, 0, 0),
...
--[[Vec3(1, 0, 0),
 ...
 SU25_RESERVE_CAMERA = LinearTransform(   --反转视角数据，参考了BF4的数据
  Vec3(-1, 0, 0),
  Vec3( 0, 1, 0),
  Vec3( 0, 0,-1),
  Vec3( 0, -2, 19.89971))
